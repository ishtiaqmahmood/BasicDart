...
class Circle {
    final double radius = 5.0; // This is a final variable, it can be initialized at declaration or in the constructor.
    ...
    static const double pi = 3.14159; // This is a static const variable, it can be used as a compile-time constant.
}